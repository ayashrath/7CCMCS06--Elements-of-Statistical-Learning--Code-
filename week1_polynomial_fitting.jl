...
# ╔═╡ 66de4be3-1c12-430f-a14f-db24dadd9b74
begin
	using CairoMakie
	using Random
	using PlutoUI
...
# ╔═╡ fe4d698e-c84d-4fd8-be5d-3fe76d01aba3
# It is stupid to not have this pre-built into Pluto as the width is already too small
...
# ╔═╡ 74f24c49-239c-46a9-96ed-ab375ecf399d
md"""
# Week 1 - Polynomail Fitting
...
# ╔═╡ 9788dcab-8e18-46b2-a35f-569169c87153
md"""
## Import Packages
"""

# ╔═╡ 037cea4f-adbe-42c5-945b-a47bfa44907a
md"""
## Define Structs and functions which showcase the structre of data that will be used and also the main processes
"""

# ╔═╡ f4a08652-ffde-47ec-8f47-a963078a92fa
begin
...
# ╔═╡ 662b6d00-21ae-43bb-8f18-dced76e39355
gen_function = sin

# ╔═╡ bebbed07-0c68-4e3b-86dd-eb6f8e396156
mean = 0.0

# ╔═╡ ddc7dbfc-3491-4e84-aabe-17539c8869e5
std = 0.0

# ╔═╡ 096ce2af-1a5b-4366-a21c-7fef1e742fe4
λ = 0

# ╔═╡ 2232d4ee-7957-42bc-b4dd-3e59838a20f1
n = 1

# ╔═╡ 3e71d09d-3928-4470-b568-889bda52323f
@bind no_datapoints PlutoUI.Slider(5:100)

# ╔═╡ f4a4f67d-44df-42ab-b54e-1e7401498c0d
batch_size = no_datapoints

# ╔═╡ b1581a8d-6b4c-4ecb-b17a-df386e2ae3e2
@bind epoch PlutoUI.Slider(5:15000)

# ╔═╡ 994e985c-c393-49c3-96ed-7d24aa3c6655
begin
	...
	function gradient_decent(params::Model, verbose::Bool = false)  # TODO - Not efficient but works for now, thus shall improve in the future
	    n = params.
	    epoch = params.epoch
	    ...
	    for iter in 1:epoch
	        ...
	        if (loss < 1e-3  || loss / prev_loss < 1e-3) && verbose  # when it converges or is good enough
	        ...
	        if (iter % div(epoch, 10) == 0  || iter == 1) && verbose
...
# ╔═╡ 8cb710b1-8b98-4b16-934b-1812c1ef7821
@bind val PlutoUI.Slider(1:15)

# ╔═╡ fb749db4-571b-460d-9753-af100bd5c5eb
data_range = -val:val

# ╔═╡ 37d13895-14ff-45ad-9824-bbd108bfc608
@bind degree PlutoUI.Slider(1:10)

# ╔═╡ 543967e9-3da3-4414-9f20-a399a186335e
begin
	# Computing - pluto should resolve that the stuff are defined later not here
...
# ╔═╡ 022c42d3-a777-4631-a830-9217d9ccf81b
begin
...
manifest_format = "2.0"
project_hash = "1ab26303083758603f0bfc776a181b3e7b7fa1a8"
